    ...
    <div className="flex min-h-screen items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-sm space-y-6 px-4 animate-fade-in-up">
        ...
        <button
          ...
          className="w-full rounded-lg border border-border bg-card py-2.5 text-sm font-medium text-foreground transition-all hover:bg-secondary hover:border-primary/30 hover:shadow-md hover:-translate-y-0.5 anim-d4"
        >
          Google
        </button>
